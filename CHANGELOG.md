...
- added `AlgorizaTeam\MediaLibrary\MediaCollections\Models\Collections\MediaCollection`
...
- added `shouldMatchBothExtensionsAndMimeTypes` to `AlgorizaTeam\MediaLibrary\ImageGenerators\BaseGenerator`
...
- Support `jpeg` in `\AlgorizaTeam\MediaLibrary\Conversion\Conversion::getResultExtension`
...
- rename `AlgorizaTeam\MediaLibraryFilesystemInterface` to `AlgorizaTeam\MediaLibrary\Filesystem\Filesystem`
...
- Added: `AlgorizaTeam\MediaLibrary\Models\Media::getHumanReadableFileSize()`
