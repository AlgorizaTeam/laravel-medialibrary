...
```bash
php artisan vendor:publish --provider="AlgorizaTeam\MediaLibraryPro\MediaLibraryProServiceProvider" --tag="media-library-pro-migrations"
php artisan migrate
```
...
return [
   ...
   'temporary_uploads_allowed_extensions' => [
        // your extensions
        ... \AlgorizaTeam\MediaLibraryPro\Support\DefaultAllowedExtensions::all(), // add this if you want to allow the default ones too
   ],
],
]
```
